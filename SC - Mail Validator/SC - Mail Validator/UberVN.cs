            ...
            for (; ; )
            {
                try
                {
                    ...
                    using (HttpRequest request = new HttpRequest())
                    {
                        ...
                        var responsePost = request.Raw(HttpMethod.POST, urlPost, (HttpContent)new StringContent("{\"answer\":{\"type\":\"VERIFY_INPUT_MOBILE\",\"userIdentifier\":{\"mobile\":{\"countryCode\":\"+33\",\"phoneNumber\":\"" + username + "\"}}},\"init\":true}")).ToString();
                        
                        if (responsePost.Contains("MOBILE_NOT_FOUND"))
                        {
